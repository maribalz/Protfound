...
<div class="row">
    ...
    @endif
        <div class="form-group col-sm-12 pad-panel" >
            ...
            {!! Form::textarea('texto_es', $slider->texto_es , ['class' => 'form-control', 'required', 'maxlength' => '300'])!!}
           
        </div>
        <div class="form-group col-sm-12 pad-panel" >
            {!!Form::label('texto','Texto En', ['class' => 'control-label'])!!}
              
            {!! Form::textarea('texto_en', $slider->texto_en , ['class' => 'form-control', 'required', 'maxlength' => '300'])!!}
           
        </div>
        <div class="form-group col-sm-12 pad-panel" >
            {!!Form::label('texto','Texto Pt', ['class' => 'control-label'])!!}
              
            {!! Form::textarea('texto_pt', $slider->texto_pt , ['class' => 'form-control', 'required', 'maxlength' => '300'])!!}
