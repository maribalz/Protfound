...
<div class="row">
    ...
    {!! Form::open(['route' => 'contenidoemp.update_contenido', 'method' => 'POST', 'class'=> 'form-horizontal', 'enctype' => 'multipart/form-data'])!!}
        <div class="form-group col-sm-12 pad-panel" >
            ...
            {!! Form::text('titulo_es', $contenido->titulo_es, ['class' => 'form-control', 'required'])!!}
           
        </div>
        <div class="form-group col-sm-12 pad-panel" >
            {!!Form::label('titulo','Título En', ['class' => 'control-label'])!!}
              
            {!! Form::text('titulo_en', $contenido->titulo_en, ['class' => 'form-control', 'required'])!!}
           
        </div>
        <div class="form-group col-sm-12 pad-panel" >
            {!!Form::label('titulo','Título Pt', ['class' => 'control-label'])!!}
              
            {!! Form::text('titulo_pt', $contenido->titulo_pt, ['class' => 'form-control', 'required'])!!}
