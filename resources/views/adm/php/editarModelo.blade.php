...
<div class="row">
	<div class="col-xs-12 col-md-11 col-md-offset-2">
		<div class="panel panel-default  col-sm-8">
            ...
            @endif
    {!!Form::model($producto, ['route'=>['modelo.update',$producto->id], 'method'=>'PUT', 'files' => true])!!}   
    {{ csrf_field() }}
        
        <div class="form-group col-sm-12 pad-panel" >
            {!!Form::label('titulo_es','Nombre español', ['class' => 'control-label'])!!}
              
            {!! Form::text('titulo_es', $producto->titulo_es , ['class' => 'form-control', 'placeholder' => 'Ingrese el nombre del modelo', 'required'])!!}
        </div>
        <div class="form-group col-sm-12 pad-panel" >
            {!!Form::label('titulo_en','Nombre Inglés', ['class' => 'control-label'])!!}
              
            {!! Form::text('titulo_en', $producto->titulo_en , ['class' => 'form-control', 'placeholder' => 'Ingrese el nombre del modelo', 'required'])!!}
        </div>
        <div class="form-group col-sm-12 pad-panel" >
            {!!Form::label('titulo_pt','Nombre Portugués', ['class' => 'control-label'])!!}
              
            {!! Form::text('titulo_pt', $producto->titulo_pt , ['class' => 'form-control', 'placeholder' => 'Ingrese el nombre del modelo', 'required'])!!}
        </div>
        <div class="form-group col-sm-12 pad-panel" >
