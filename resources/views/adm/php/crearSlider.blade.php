...
<div class="row">
    ...
    {{ csrf_field() }}
        <div class="form-group col-sm-12 pad-panel" >
            ...
            {!! Form::textarea('texto_es', null , ['class' => 'form-control', 'required', 'maxlength' => '300'])!!}
           
        </div>
        <div class="form-group col-sm-12 pad-panel" >
            {!!Form::label('texto','Texto En', ['class' => 'control-label'])!!}
              
            {!! Form::textarea('texto_en', null , ['class' => 'form-control', 'required', 'maxlength' => '300'])!!}
           
        </div>
        <div class="form-group col-sm-12 pad-panel" >
            {!!Form::label('texto','Texto Pt', ['class' => 'control-label'])!!}
              
            {!! Form::textarea('texto_pt', null , ['class' => 'form-control', 'required', 'maxlength' => '300'])!!}
