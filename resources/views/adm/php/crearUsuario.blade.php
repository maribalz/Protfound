...
<div class="row">
    ...
    {{ csrf_field() }}
        ...
        <div class="form-group col-sm-12 pad-panel" >
            ...
            {!! Form::text('usuario', null, ['class' => 'form-control', 'placeholder' => 'Ingrese un usuario', 'required'])!!}
        ...
        <div class="form-group col-sm-12 pad-panel" >
            {!!Form::label('password','Nivel ', ['class' => 'control-label'])!!}
              
            {!! Form::select('nivel', ['usuario' => 'Usuario', 'administrador' => 'Administrador'], null, ['class' => 'form-control']) !!}
