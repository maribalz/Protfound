	...
	<div class="col-xs-12 col-md-10 col-md-offset-2">
		<div class="panel panel-default  col-sm-8">
            <div class="panel-heading">
                <h3 class="panel-title">Crear Novedad</h3>
            </div>
            @if(count($errors) > 0)
            ...
            @endif
    {!! Form::open([ 'route' => 'novedadm.store', 'method' => 'POST', 'class'=> 'form-horizontal', 'files' => true ])!!}
    {{ csrf_field() }}
        <div class="form-group col-sm-12 pad-panel" >
            {!!Form::label('nombre_es','Nombre Es', ['class' => 'control-label'])!!}
              
            {!! Form::text('nombre_es', null , ['class' => 'form-control', 'placeholder' => 'Ingrese el nombre de la novedad', 'required', 'maxlenght' => '200'])!!}
           
        </div>
        <div class="form-group col-sm-12 pad-panel" >
            {!!Form::label('nombre_en','Nombre En', ['class' => 'control-label'])!!}
              
            {!! Form::text('nombre_en', null , ['class' => 'form-control', 'placeholder' => 'Ingrese el nombre de la novedad', 'required', 'maxlenght' => '200'])!!}
           
        </div>
        <div class="form-group col-sm-12 pad-panel" >
            {!!Form::label('nombre_pt','Nombre Pt', ['class' => 'control-label'])!!}
              
            {!! Form::text('nombre_pt', null , ['class' => 'form-control', 'placeholder' => 'Ingrese el nombre de la novedad', 'required', 'maxlenght' => '200'])!!}
        ...
        <div class="form-group col-sm-12 pad-panel" >
            ...
            {!! Form::text('fecha', null , ['class' => 'form-control', 'placeholder' => '', 'required','maxlenght' => '30'])!!}
           
        </div>
        <div class="form-group col-sm-12 pad-panel" >
            {!!Form::label('texto_breve_es','Descripción breve Es', ['class' => 'control-label'])!!}
              
            {!! Form::textarea('texto_breve_es',null, ['class' => 'form-control', 'maxlenght' => '2000', 'required'])!!}
           
        </div>
        <div class="form-group col-sm-12 pad-panel" >
            {!!Form::label('texto_breve_en','Descripción breve En', ['class' => 'control-label'])!!}
              
            {!! Form::textarea('texto_breve_en',null, ['class' => 'form-control', 'maxlenght' => '2000', 'required'])!!}
           
        </div>
        <div class="form-group col-sm-12 pad-panel" >
            {!!Form::label('texto_breve_pt','Descripción breve Pt', ['class' => 'control-label'])!!}
              
            {!! Form::textarea('texto_breve_pt',null, ['class' => 'form-control', 'maxlenght' => '2000', 'required'])!!}
           
        </div>
        <div class="form-group col-sm-12 pad-panel" >
            {!!Form::label('texto_es','Texto Es', ['class' => 'control-label'])!!}
              
            {!! Form::textarea('texto_es',null, ['class' => 'form-control', 'maxlenght' => '4000', 'required'])!!}
           
        </div>
        <div class="form-group col-sm-12 pad-panel" >
            {!!Form::label('texto_en','Texto En', ['class' => 'control-label'])!!}
              
            {!! Form::textarea('texto_en',null, ['class' => 'form-control', 'maxlenght' => '4000', 'required'])!!}
           
        </div>
        <div class="form-group col-sm-12 pad-panel" >
            {!!Form::label('texto_pt','Texto Pt', ['class' => 'control-label'])!!}
              
            {!! Form::textarea('texto_pt',null, ['class' => 'form-control', 'maxlenght' => '4000', 'required'])!!}
