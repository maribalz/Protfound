...
<div class="container margen-top">
    ...
    <div class="row">
      ...
      <div class="col s12  titledes"  style="margin-top: 0px; text-align: left;">
    ...
    <div class="row">
        ...
        @foreach($productos as $producto)
          ...
          <div class="col s12 m4" style="margin-bottom: 40px;">
            ...
            <a href="{{route('sectores.productos',$producto->id)}}">

              <div class="border">

                <img class="responsive-img" src="{{asset($producto->imagen)}}" alt="{{$producto->{'titulo_'.$idioma} }}">
